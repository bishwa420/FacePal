...
public class JavaFaces {
    ...
    protected static String trainingImagePath = "E:\\Google Drive\\FacePal\\Server\\JavaFaces\\trainingImages";
    protected static String eigenCachePath = "C:\\Users\\bishw\\Desktop\\New folder";
    protected static int numberOfFaces = 0;
    protected static double matchDistance;
    protected static String matchedName;
...
//    public static void main(String[] args){
    public static void trainImage(String trainingPath, String eigenPath) {
